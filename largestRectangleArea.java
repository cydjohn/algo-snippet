...
public class Solution {
    public int largestRectangleArea(int[] heights) {
        ...
        int max = 0;
        for (int i = 0; i <= len; i++) {
            /*it is important to have i == len and h = 0 for the last time int the for loop, since 0 < all possible heights and it would garantee every element in the stack is pop out and be compared to get the result.*/
